        ...
        >
          <el-card class="box-card">
            <div slot="header" class="clearfix">
              <span><b id="titulo-bl">Metodo Boole</b></span> <i class="el-icon-arrow-right" /> <MostrarNuevaEcuacion id="mostrarNuevaEcuacion" :nueva-ecuacion="ecuacion" :valor-superior="valorSuperior" :valor-inferior="valorInferior" />
              <el-button
                id="limpiarBtn"
                style="float: right"
                type="danger"
