        ...
        >
          <el-card class="box-card">
            <div slot="header" class="clearfix">
              <span><b>Simpson Abierto</b></span> <i class="el-icon-arrow-right" /> <MostrarNuevaEcuacion :nueva-ecuacion="ecuacion" :valor-superior="valorSuperior" :valor-inferior="valorInferior" />
              <el-button
                style="float: right"
                type="danger"
                size="small"
