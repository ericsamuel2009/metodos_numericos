const steps = [
  {
    ...
    popover: {
      title: 'Bienvenido!!',
      description: 'Estás a punto de resolver integrales definidas por el método <b>simpson 3/8</b> , para esto se aplica la fórmula, I = 3Δ / 8 [F(X1)+3F(X2)+3F(X3)+F(X4)].',
      position: 'botton'
    }
  },
  {
  ...
  },
  {
    ...
    popover: {
      ...
      description: 'Podrás mirar el resultado de Delta al aplicar Δ = b - a / 3.',
      position: 'left'
    }
  },
  {
  ...
  },
  {
    ...
    popover: {
      title: 'Totales!',
      description: 'Podremos Observar los totales de la sumatoria (Σ) de X e I que es igual a: 3Δ / 8 [F(X1)+3F(X2)+3F(X3)+F(X4)] aplicando esta formula.',
      position: 'top'
    }
  },
  {
