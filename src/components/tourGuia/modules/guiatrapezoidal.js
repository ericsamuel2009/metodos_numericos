const steps = [
  {
    ...
    popover: {
      title: 'Bienvenido!!',
      description: 'Estás a punto de resolver integrales definidas por el método <b>Trapezoidal</b>, para esto se aplica la fórmula, I = Δ / 2 [F(X0)+2F(X1)+2F(X2)..+F(Xn)].',
      position: 'botton'
    }
  },
  {
  ...
  },
  {
    ...
    popover: {
      title: 'Para que esto?',
      description: 'Aqui podras agregar el valor de "n" reemplazando la formula Δ = b - a / n.',
      position: 'left'
    }
  },
  {
  ...
  },
  {
    ...
    popover: {
      title: 'Totales!',
      description: 'Podremos Observar los totales de la sumatoria (Σ) de X e I que es igual a: I = Δ / 2 [F(X0)+2F(X1)+2F(X2)..+F(Xn)] aplicando esta formula.',
      position: 'top'
    }
  },
  {
